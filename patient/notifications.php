...
<div class="page-header">
    <div class="breadcrumb"><a href="index.php">Dashboard</a> <i class="fas fa-chevron-right" style="font-size:0.7rem"></i> Notifications</div>
    <h1>Notifications</h1>
</div>
...
<?php else: foreach ($notifications as $n):
    ...
    $type = $n['type'] ?? 'system';
?>
<div class="card" style="padding:1.25rem;margin-bottom:0.75rem;display:flex;gap:1rem;align-items:flex-start">
    <div style="width:40px;height:40px;border-radius:50%;background:<?= str_replace('#','rgba(',substr($colors[$type]??'#8b5cf6',1)).', 0.15)' ?>;display:flex;align-items:center;justify-content:center;flex-shrink:0">
